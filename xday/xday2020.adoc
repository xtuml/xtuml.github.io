...
__This conference may look totally different from previous years.  Know your
...
November to meet in the traditional fashion.__

__However, we are planning in case it cannot.  There is the potential of
slipping the date into 2021, but there is also the possibility of a
virtual gathering.  Your planning committee is super creative and has access
...
virtual happy hours and virtual tours and virtual panel discussions.  Such
approaches take a great deal of preparation which we are willing and even
now proceeding to explore.__
