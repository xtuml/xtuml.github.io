...
// | https://xtuml.github.io/xday/smdays2023.html[**Pay for Shlaer-Mellor Day**]

== What is this?

*Shlaer-Mellor Day 2023* is a modeling conference and represents the 10th
edition of Shlaer-Mellor Day (formerly known as xtUML Day).  (See <<Previous xtUML Days>>.)
Shlaer-Mellor Day is the most dense gathering of the year of Shlaer-Mellor modelers.
...
John Wolfe, Paul Francis, Colin Carter, Keith Brown, Levi Starrett and others.
...
Register by emailing the chair (cortland.starrett at onefact.net).
Provide name and company/school information.  Do this even if you pay
through the electronic portal.

You can pay the conference registration fee by clicking 
https://xtuml.github.io/xday/smdays2023.html[**here TODO COMING SOON**]
...
A dinner gathering is planned in the UK in Bristol on the evening of TODO
November 2023.  The venue is TODO at 19:30.  Dinner is included in the
conference registration (including a significant other).

A dinner gathering is planned in Linköping, Sweden on the evening of TODO
November 2023.  The venue and time are TODO.
...
lasting (roughly) 4 hours.  The host will welcome attendees at the start.
The host will make significant introductions.  Shlaer-Mellor Community
members will give short updates on their applications and experiences.
Presentations with Q&A and discussions will fill the session.
An open moderated discussion time will end the day.

A detailed agenda will be available in October upon solidification of the
presentation line-up.

== Newletter Updates Regarding Shlaer-Mellor Day

* https://www.youtube.com/watch?v=2_OAuDWMyHc[Speaker Preparation Instructions Video (August 2020)]

== Conference Organization and Contacts
...
//=== https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=SACZZNV45K8MU[**Pay for Shlaer-Mellor Day 2023 here.**]
