...
lasting (roughly) 4 hours.  Presentations with Q&A and discussions will
...
//* https://youtu.be/4ouYCYWzpwI[Populating Roadway Models -John Wolfe and Alasdar Mullarney - Shlaer-Mellor Day 2022]
...
November 2023.  The venue is TODO.  Dinner is included in the
