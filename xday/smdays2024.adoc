...
A dinner gathering is planned in the UK in TODO on the evening of
TODO.  The venue is TODO.  Dinner is included in the
conference registration (including a significant other).

A dinner gathering is planned in Linköping, Sweden on the evening of
TODO.  The venue and time are TODO.

A gathering is planned in Tokyo, Japan on the evening of
TODO.  The venue and time are TODO.
