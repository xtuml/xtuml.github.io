...
You can pay the registration fee by clicking **coming soon**.
////
...
////
=== https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2P3UUJP9KHUD2[**Pay for Shlaer-Mellor Day 2024 here.**]
////
