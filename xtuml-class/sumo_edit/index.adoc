...
* link:sumo_create1{outfilesuffix}[Assignment 1]
* link:sumo_create2{outfilesuffix}[Assignment 2]
* link:sumo_create3{outfilesuffix}[Assignment 3]
* link:sumo_create4{outfilesuffix}[Assignment 4]
* link:sumo_create5{outfilesuffix}[Assignment 5]
