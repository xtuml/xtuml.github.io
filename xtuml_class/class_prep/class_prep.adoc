...
a shared folder from the local machine while logging in, link:connect_shared_folders{outfilesuffix}[follow these instructions].  

* Launch __Remote Desktop Connection__   

image::img/Launching_Remote_Desktop.png[Launching Remote Desktop,height="703",width="401"]

* Enter one of the available IP Addresses: __54.238.176.121__   
