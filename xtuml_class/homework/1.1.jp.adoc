...
NOTE:  Your new account request requires action from an engineer on the
BridgePoint engineering team.  It may take up to 1 full day for the work
to be completed to set up your account.  You will receive a notice by email
when your account is ready to use.

Navigate to https://support.onefact.net/issues/{hwtrackingissue}[issue {hwtrackingissue}]
