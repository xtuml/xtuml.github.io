...
<<Running the latest published version of the integration project, see here>>
...
==== Running the latest published version of the integration project
...
link:https://github.com/xtuml/tower/blob/main/models/test-files/processed/PoC_CBC_Test1.json[`PoC_CBC_Test1.json`]
to the `test-files/incoming/` directory in your current directory. You will see
