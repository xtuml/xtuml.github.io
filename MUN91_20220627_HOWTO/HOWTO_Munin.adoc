...
through a simple command:
  ...
  open -a Finder ~/git/munin/models/test-files/processed/  # mac
  xdg-open ~/git/munin/models/test-files/processed/        # linux
  explorer C:\git\munin\models\test-files\processed\       # windows

. Open another file explorer window and navigate to the
`models/test-files/incoming/` directory within the repository:

  open -a Finder ~/git/munin/models/test-files/incoming/  # mac
  xdg-open ~/git/munin/models/test-files/incoming/        # linux
  explorer C:\git\munin\models\test-files\incoming\       # windows
